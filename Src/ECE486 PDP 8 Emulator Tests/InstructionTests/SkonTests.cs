...
{
    [TestClass]
    public class SkonTests
    {
        [TestMethod]
        public void TestSkonArgumentPassthrough()
        {
            InstructionItems TestItems = new InstructionItems()
            {
                ...
                pcCounter = 1,
                InstructionRegister = Convert.ToInt32(6000.ToString(), 8),
                OsrSwitchBits = 0xFFF
            };
            ...
            Assert.AreEqual(0, TestIotInstruction.clockCycles);
            Assert.AreEqual(Constants.OpCode.IOT, TestIotInstruction.instructionType);

        }

        [TestMethod]
        public void TestSkonOperation()
        {
