...
{
    [TestClass]
    public class MqaTests
    {
        [TestMethod]
        public void TestMqaArgumentPassthrough()
        {
            InstructionItems TestItems = new InstructionItems()
            {
                ...
                pcCounter = 1,
                InstructionRegister = Convert.ToInt32(7501.ToString(), 8)
        ...
        public void TestMqaOperation()
        {
            ...
            InstructionItems TestItems = new InstructionItems()
            {
                ...
                pcCounter = 5649,
                InstructionRegister = Convert.ToInt32(7421.ToString(), 8)
            };
