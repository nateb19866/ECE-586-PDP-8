...
{
    public class SwpInstruction : IInstruction
    {

        private int ClockCycles = 1;
        private Constants.Microcode InstructionType = Constants.Microcode.SWP;


        public InstructionResult ExecuteInstruction(InstructionItems instItems)
        {
            // Need to implement swaps the contents of AC and MQ ( MWA and MQL )
